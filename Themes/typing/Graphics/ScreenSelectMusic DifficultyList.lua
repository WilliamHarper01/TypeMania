local function arrow_bounce(self, x, y)
	...
	self:effecttiming(2.0,0.0,2.0,0.0)
...
-- 			self:setaux(1);
	...
	Def.StepsDisplayList {
		...
		self:diffusealpha(0):zoomx(0):decelerate(0.4):zoomx(0.9):diffusealpha(1)
		end;
		...
		CursorP1 = Def.ActorFrame {
			...
			LoadActor(THEME:GetPathG("_StepsDisplayListRow","Cursor")) .. {
				InitCommand=cmd(diffuse,ColorLightTone(color("#00FF00"));x,58;zoom,0.5);
			};
		};
